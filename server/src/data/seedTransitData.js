...
export const initialStops = [
  ...
  },
  {
    ...
    code: 'BHC-03',
    name: 'Bunts Hostel Circle',
    locality: 'Bunts Hostel',
    landmark: 'Beside Ramakrishna College',
    latitude: 12.8752,
    longitude: 74.8488,
    wheelchair_accessible: true,
    is_active: true
  ...
  },
  {
    ...
    code: 'KLR-07',
    name: 'Kulur Bridge Junction',
    locality: 'Kulur',
    landmark: 'Phalguni River Bridge & Tannirbhavi Beach turn',
    latitude: 12.9230,
    longitude: 74.8210,
    wheelchair_accessible: true,
    is_active: true
  },
  {
    ...
    code: 'PNB-08',
    name: 'Panambur Beach / NMPT',
    locality: 'Panambur',
    landmark: 'Panambur Beach Entrance & Coast Guard HQ',
    latitude: 12.9480,
    longitude: 74.8080,
    wheelchair_accessible: true,
    is_active: true
  },
  {
    ...
    locality: 'Baikampady',
    landmark: 'KIADB Industrial Zone Main Gate',
    latitude: 12.9620,
    longitude: 74.8095,
    wheelchair_accessible: true,
    is_active: true
  },
  {
    ...
    locality: 'Surathkal',
    landmark: 'Surathkal NH Flyover & Daily Market',
    latitude: 12.9820,
    longitude: 74.7980,
    wheelchair_accessible: true,
    is_active: true
  },
  {
    ...
    landmark: 'National Institute of Tech Main Academic Entrance',
    latitude: 13.0110,
    longitude: 74.7930,
    wheelchair_accessible: true,
    is_active: true
  },
  {
    ...
    code: 'KKN-12',
    name: 'Kankanady Circle',
    locality: 'Kankanady',
    landmark: 'Father Muller Hospital & College of Nursing',
    latitude: 12.8705,
    longitude: 74.8610,
    wheelchair_accessible: true,
    is_active: true
  },
  {
    ...
    code: 'PMP-13',
    name: 'Pumpwell (Mahaveer Circle)',
    locality: 'Pumpwell',
    landmark: 'Southern Transit Hub & KSRTC Junction',
    latitude: 12.8610,
    longitude: 74.8680,
    wheelchair_accessible: true,
    is_active: true
  },
  {
    ...
    code: 'TKT-14',
    name: 'Thokkottu Overbridge',
    locality: 'Thokkottu',
    landmark: 'Ullal Bypass & Highway Overpass',
    latitude: 12.8250,
    longitude: 74.8720,
    wheelchair_accessible: true,
    is_active: true
  },
  {
    ...
    landmark: 'KS Hegde & Yenepoya University Medical Campuses',
    latitude: 12.8120,
    longitude: 74.8890,
    wheelchair_accessible: true,
    is_active: true
  },
  {
    ...
    locality: 'Konaje',
    landmark: 'Mangalagangotri Main Academic Quadrangle',
    latitude: 12.8190,
    longitude: 74.9270,
    wheelchair_accessible: true,
    is_active: true
  },
  {
    ...
    code: 'MU-S-17',
    name: 'Mangalore University South Gate',
    locality: 'Konaje',
    landmark: 'Hostel Complex Block 3 & University Post Office',
    latitude: 12.8140,
    longitude: 74.9310,
    wheelchair_accessible: true,
    is_active: true
  },
  {
    ...
    code: 'MDP-18',
    name: 'Mudipu Infosys IT SEZ',
    locality: 'Mudipu',
    landmark: 'Special Economic Zone Innovation Tower Gate 1',
    latitude: 12.8050,
    longitude: 74.9450,
    wheelchair_accessible: true,
    is_active: true
  },
  {
    ...
    locality: 'Kadri',
    landmark: 'Historic Manjunatha Temple & Kadri Park',
    latitude: 12.8870,
    longitude: 74.8620,
    wheelchair_accessible: true,
    is_active: true
  },
  {
    ...
    code: 'MLK-20',
    name: 'Mallikatta Circle',
    locality: 'Mallikatta',
    landmark: 'Near Lions Club & St. Agnes College',
    latitude: 12.8790,
    longitude: 74.8560,
    wheelchair_accessible: true,
    is_active: true
  },
  {
    ...
    locality: 'Attavar',
    landmark: 'Platform 1 Main Booking Concourse',
    latitude: 12.8612,
    longitude: 74.8398,
    wheelchair_accessible: true,
    is_active: true
  },
  {
    ...
    code: 'MAJN-22',
    name: 'Mangalore Junction Railway Station (MAJN)',
    locality: 'Padil',
    landmark: 'Junction Station Entrance Road',
    latitude: 12.8720,
    longitude: 74.8810,
    wheelchair_accessible: true,
    is_active: true
  },
  {
    ...
    locality: 'Bajpe / Kenjar',
    landmark: 'Terminal 1 Departure / Arrival Porch',
    latitude: 12.9610,
    longitude: 74.8900,
    wheelchair_accessible: true,
    is_active: true
  },
  {
    ...
    code: 'ULL-24',
    name: 'Ullal Rani Abbakka Circle',
    locality: 'Ullal',
    landmark: 'Rani Abbakka Statue & Someshwar Beach Turn',
    latitude: 12.8050,
    longitude: 74.8560,
    wheelchair_accessible: true,
    is_active: true
...
export const initialRoutes = [
  // 1. Route 15: State Bank ➔ Surathkal NITK Express
  {
    ...
    route_number: '15',
    route_name: 'State Bank ➔ Surathkal NITK Express',
  ...
  // 2. Route 11: State Bank ➔ Mangalore University (Konaje)
  {
    ...
    route_number: '11',
    route_name: 'State Bank ➔ Mangalore University (Konaje)',
    origin_stop_id: 'b0000001-0000-0000-0000-000000000001',
    destination_stop_id: 'b0000001-0000-0000-0000-000000000016',
  ...
  // 3. Route 42: State Bank ➔ Mudipu Infosys IT SEZ
  {
    ...
    route_number: '42',
    route_name: 'State Bank ➔ Mudipu Infosys IT SEZ',
    origin_stop_id: 'b0000001-0000-0000-0000-000000000001',
    destination_stop_id: 'b0000001-0000-0000-0000-000000000018',
    bus_type: 'City Express',
  ...
  // 4. Route 27: State Bank ➔ Airport (Bajpe / IXE)
  {
    ...
    route_number: '27',
    route_name: 'State Bank ➔ Airport (Bajpe / IXE)',
    origin_stop_id: 'b0000001-0000-0000-0000-000000000001',
    destination_stop_id: 'b0000001-0000-0000-0000-000000000023',
  ...
  // 5. Route 24A: State Bank ➔ Kottara Chowki Direct
  {
    ...
    route_number: '24A',
    route_name: 'State Bank ➔ Kottara Chowki Direct',
    origin_stop_id: 'b0000001-0000-0000-0000-000000000001',
  ...
  // 6. Route 19: State Bank ➔ Panambur Beach
  {
    ...
    route_number: '19',
    route_name: 'State Bank ➔ Panambur Beach & Port',
    origin_stop_id: 'b0000001-0000-0000-0000-000000000001',
    destination_stop_id: 'b0000001-0000-0000-0000-000000000008',
    bus_type: 'City Standard',
  ...
  // 7. Route 3A: State Bank ➔ Kadri Hills & Temple
  {
    ...
    route_number: '3A',
    route_name: 'State Bank ➔ Kadri Hills & Temple',
    origin_stop_id: 'b0000001-0000-0000-0000-000000000001',
    destination_stop_id: 'b0000001-0000-0000-0000-000000000019',
    bus_type: 'City Standard',
  ...
  // 8. Route 44: State Bank ➔ Ullal Rani Abbakka Circle
  {
    ...
    route_number: '44',
    route_name: 'State Bank ➔ Ullal Rani Abbakka Circle',
    origin_stop_id: 'b0000001-0000-0000-0000-000000000001',
    destination_stop_id: 'b0000001-0000-0000-0000-000000000024',
    bus_type: 'City Standard',
  ...
  // 9. Route 22: State Bank ➔ Mangalore Junction Railway (MAJN)
  {
    ...
    route_number: '22',
    route_name: 'State Bank ➔ Mangalore Junction Railway (MAJN)',
    origin_stop_id: 'b0000001-0000-0000-0000-000000000001',
    destination_stop_id: 'b0000001-0000-0000-0000-000000000022',
    bus_type: 'City Standard',
  ...
  // 10. Route 33: KSRTC Bejai ➔ Mangalore University (via Pumpwell)
  {
    ...
    route_number: '33',
    route_name: 'KSRTC Bejai ➔ Mangalore University (via Pumpwell)',
    origin_stop_id: 'b0000001-0000-0000-0000-000000000005',
    destination_stop_id: 'b0000001-0000-0000-0000-000000000016',
    bus_type: 'Campus Shuttle',
  ...
  // 11. Route 16: Kottara Chowki ➔ Surathkal NITK Shuttle
  {
    ...
    route_number: '16',
    route_name: 'Kottara Chowki ➔ Surathkal NITK Shuttle',
    origin_stop_id: 'b0000001-0000-0000-0000-000000000006',
    destination_stop_id: 'b0000001-0000-0000-0000-000000000011',
    bus_type: 'City Standard',
  ...
  // 12. Route 47: Deralakatte Medical Hub ➔ Mudipu IT SEZ
  {
    ...
    route_number: '47',
    route_name: 'Deralakatte Medical Hub ➔ Mudipu IT SEZ',
    origin_stop_id: 'b0000001-0000-0000-0000-000000000015',
    destination_stop_id: 'b0000001-0000-0000-0000-000000000018',
    bus_type: 'City Standard',
...
// Sequential Station Stops for each Mangalore Route
export const initialRouteStops = [
  // -------------------------------------------------------------
  // Route 15: State Bank ➔ Surathkal NITK Express
  // -------------------------------------------------------------
  ...
  { route_id: 'r0000001-0000-0000-0000-000000000001', stop_id: 'b0000001-0000-0000-0000-000000000002', stop_sequence: 2, distance_from_start_km: 1.0, time_from_start_mins: 4, is_major_interchange: false },
  { route_id: 'r0000001-0000-0000-0000-000000000001', stop_id: 'b0000001-0000-0000-0000-000000000004', stop_sequence: 3, distance_from_start_km: 3.5, time_from_start_mins: 10, is_major_interchange: false },
  { route_id: 'r0000001-0000-0000-0000-000000000001', stop_id: 'b0000001-0000-0000-0000-000000000006', stop_sequence: 4, distance_from_start_km: 7.5, time_from_start_mins: 20, is_major_interchange: true },
  { route_id: 'r0000001-0000-0000-0000-000000000001', stop_id: 'b0000001-0000-0000-0000-000000000007', stop_sequence: 5, distance_from_start_km: 10.2, time_from_start_mins: 26, is_major_interchange: false },
  { route_id: 'r0000001-0000-0000-0000-000000000001', stop_id: 'b0000001-0000-0000-0000-000000000008', stop_sequence: 6, distance_from_start_km: 13.0, time_from_start_mins: 31, is_major_interchange: true },
  { route_id: 'r0000001-0000-0000-0000-000000000001', stop_id: 'b0000001-0000-0000-0000-000000000009', stop_sequence: 7, distance_from_start_km: 15.5, time_from_start_mins: 36, is_major_interchange: false },
  { route_id: 'r0000001-0000-0000-0000-000000000001', stop_id: 'b0000001-0000-0000-0000-000000000010', stop_sequence: 8, distance_from_start_km: 18.5, time_from_start_mins: 40, is_major_interchange: true },
  { route_id: 'r0000001-0000-0000-0000-000000000001', stop_id: 'b0000001-0000-0000-0000-000000000011', stop_sequence: 9, distance_from_start_km: 21.0, time_from_start_mins: 45, is_major_interchange: true },

  // -------------------------------------------------------------
  // Route 11: State Bank ➔ Mangalore University (Konaje)
  // -------------------------------------------------------------
  ...
  { route_id: 'r0000001-0000-0000-0000-000000000002', stop_id: 'b0000001-0000-0000-0000-000000000002', stop_sequence: 2, distance_from_start_km: 1.0, time_from_start_mins: 4, is_major_interchange: false },
  { route_id: 'r0000001-0000-0000-0000-000000000002', stop_id: 'b0000001-0000-0000-0000-000000000012', stop_sequence: 3, distance_from_start_km: 3.5, time_from_start_mins: 10, is_major_interchange: true },
  { route_id: 'r0000001-0000-0000-0000-000000000002', stop_id: 'b0000001-0000-0000-0000-000000000013', stop_sequence: 4, distance_from_start_km: 5.5, time_from_start_mins: 14, is_major_interchange: true },
  { route_id: 'r0000001-0000-0000-0000-000000000002', stop_id: 'b0000001-0000-0000-0000-000000000014', stop_sequence: 5, distance_from_start_km: 9.8, time_from_start_mins: 22, is_major_interchange: true },
  { route_id: 'r0000001-0000-0000-0000-000000000002', stop_id: 'b0000001-0000-0000-0000-000000000015', stop_sequence: 6, distance_from_start_km: 14.0, time_from_start_mins: 30, is_major_interchange: true },
  { route_id: 'r0000001-0000-0000-0000-000000000002', stop_id: 'b0000001-0000-0000-0000-000000000016', stop_sequence: 7, distance_from_start_km: 19.5, time_from_start_mins: 42, is_major_interchange: true },
  { route_id: 'r0000001-0000-0000-0000-000000000002', stop_id: 'b0000001-0000-0000-0000-000000000017', stop_sequence: 8, distance_from_start_km: 20.8, time_from_start_mins: 45, is_major_interchange: false },

  // -------------------------------------------------------------
  // Route 42: State Bank ➔ Mudipu Infosys IT SEZ
  // -------------------------------------------------------------
  { route_id: 'r0000001-0000-0000-0000-000000000003', stop_id: 'b0000001-0000-0000-0000-000000000001', stop_sequence: 1, distance_from_start_km: 0.0, time_from_start_mins: 0, is_major_interchange: true },
  { route_id: 'r0000001-0000-0000-0000-000000000003', stop_id: 'b0000001-0000-0000-0000-000000000012', stop_sequence: 2, distance_from_start_km: 3.5, time_from_start_mins: 10, is_major_interchange: true },
  { route_id: 'r0000001-0000-0000-0000-000000000003', stop_id: 'b0000001-0000-0000-0000-000000000013', stop_sequence: 3, distance_from_start_km: 5.5, time_from_start_mins: 14, is_major_interchange: true },
  { route_id: 'r0000001-0000-0000-0000-000000000003', stop_id: 'b0000001-0000-0000-0000-000000000014', stop_sequence: 4, distance_from_start_km: 9.8, time_from_start_mins: 22, is_major_interchange: true },
  { route_id: 'r0000001-0000-0000-0000-000000000003', stop_id: 'b0000001-0000-0000-0000-000000000015', stop_sequence: 5, distance_from_start_km: 14.0, time_from_start_mins: 30, is_major_interchange: true },
  { route_id: 'r0000001-0000-0000-0000-000000000003', stop_id: 'b0000001-0000-0000-0000-000000000016', stop_sequence: 6, distance_from_start_km: 19.5, time_from_start_mins: 42, is_major_interchange: true },
  { route_id: 'r0000001-0000-0000-0000-000000000003', stop_id: 'b0000001-0000-0000-0000-000000000018', stop_sequence: 7, distance_from_start_km: 24.0, time_from_start_mins: 50, is_major_interchange: true },

  // -------------------------------------------------------------
  // Route 27: State Bank ➔ Airport (Bajpe / IXE)
  // -------------------------------------------------------------
  { route_id: 'r0000001-0000-0000-0000-000000000004', stop_id: 'b0000001-0000-0000-0000-000000000001', stop_sequence: 1, distance_from_start_km: 0.0, time_from_start_mins: 0, is_major_interchange: true },
  ...
  // -------------------------------------------------------------
  { route_id: 'r0000001-0000-0000-0000-000000000005', stop_id: 'b0000001-0000-0000-0000-000000000001', stop_sequence: 1, distance_from_start_km: 0.0, time_from_start_mins: 0, is_major_interchange: true },
  { route_id: 'r0000001-0000-0000-0000-000000000005', stop_id: 'b0000001-0000-0000-0000-000000000002', stop_sequence: 2, distance_from_start_km: 1.0, time_from_start_mins: 4, is_major_interchange: false },
  { route_id: 'r0000001-0000-0000-0000-000000000005', stop_id: 'b0000001-0000-0000-0000-000000000004', stop_sequence: 3, distance_from_start_km: 3.5, time_from_start_mins: 10, is_major_interchange: false },
  { route_id: 'r0000001-0000-0000-0000-000000000005', stop_id: 'b0000001-0000-0000-0000-000000000005', stop_sequence: 4, distance_from_start_km: 5.0, time_from_start_mins: 15, is_major_interchange: true },
  { route_id: 'r0000001-0000-0000-0000-000000000005', stop_id: 'b0000001-0000-0000-0000-000000000006', stop_sequence: 5, distance_from_start_km: 7.8, time_from_start_mins: 22, is_major_interchange: true },

  // -------------------------------------------------------------
  // Route 19: State Bank ➔ Panambur Beach
  // -------------------------------------------------------------
  ...
  { route_id: 'r0000001-0000-0000-0000-000000000006', stop_id: 'b0000001-0000-0000-0000-000000000004', stop_sequence: 2, distance_from_start_km: 3.5, time_from_start_mins: 9, is_major_interchange: false },
  { route_id: 'r0000001-0000-0000-0000-000000000006', stop_id: 'b0000001-0000-0000-0000-000000000006', stop_sequence: 3, distance_from_start_km: 7.5, time_from_start_mins: 18, is_major_interchange: true },
  { route_id: 'r0000001-0000-0000-0000-000000000006', stop_id: 'b0000001-0000-0000-0000-000000000007', stop_sequence: 4, distance_from_start_km: 10.0, time_from_start_mins: 24, is_major_interchange: false },
  { route_id: 'r0000001-0000-0000-0000-000000000006', stop_id: 'b0000001-0000-0000-0000-000000000008', stop_sequence: 5, distance_from_start_km: 12.0, time_from_start_mins: 28, is_major_interchange: true },

  // -------------------------------------------------------------
  // Route 3A: State Bank ➔ Kadri Manjunatha Temple & Park
  // -------------------------------------------------------------
  { route_id: 'r0000001-0000-0000-0000-000000000007', stop_id: 'b0000001-0000-0000-0000-000000000001', stop_sequence: 1, distance_from_start_km: 0.0, time_from_start_mins: 0, is_major_interchange: true },
  { route_id: 'r0000001-0000-0000-0000-000000000007', stop_id: 'b0000001-0000-0000-0000-000000000002', stop_sequence: 2, distance_from_start_km: 1.0, time_from_start_mins: 4, is_major_interchange: false },
  { route_id: 'r0000001-0000-0000-0000-000000000007', stop_id: 'b0000001-0000-0000-0000-000000000003', stop_sequence: 3, distance_from_start_km: 2.5, time_from_start_mins: 8, is_major_interchange: false },
  { route_id: 'r0000001-0000-0000-0000-000000000007', stop_id: 'b0000001-0000-0000-0000-000000000020', stop_sequence: 4, distance_from_start_km: 4.0, time_from_start_mins: 13, is_major_interchange: true },
  { route_id: 'r0000001-0000-0000-0000-000000000007', stop_id: 'b0000001-0000-0000-0000-000000000019', stop_sequence: 5, distance_from_start_km: 5.5, time_from_start_mins: 18, is_major_interchange: true },

  // -------------------------------------------------------------
  // Route 44: State Bank ➔ Ullal Rani Abbakka Circle
  // -------------------------------------------------------------
  { route_id: 'r0000001-0000-0000-0000-000000000008', stop_id: 'b0000001-0000-0000-0000-000000000001', stop_sequence: 1, distance_from_start_km: 0.0, time_from_start_mins: 0, is_major_interchange: true },
  { route_id: 'r0000001-0000-0000-0000-000000000008', stop_id: 'b0000001-0000-0000-0000-000000000012', stop_sequence: 2, distance_from_start_km: 3.5, time_from_start_mins: 10, is_major_interchange: true },
  { route_id: 'r0000001-0000-0000-0000-000000000008', stop_id: 'b0000001-0000-0000-0000-000000000013', stop_sequence: 3, distance_from_start_km: 5.5, time_from_start_mins: 14, is_major_interchange: true },
  { route_id: 'r0000001-0000-0000-0000-000000000008', stop_id: 'b0000001-0000-0000-0000-000000000014', stop_sequence: 4, distance_from_start_km: 9.8, time_from_start_mins: 22, is_major_interchange: true },
  { route_id: 'r0000001-0000-0000-0000-000000000008', stop_id: 'b0000001-0000-0000-0000-000000000024', stop_sequence: 5, distance_from_start_km: 12.5, time_from_start_mins: 30, is_major_interchange: true },

  // -------------------------------------------------------------
  // Route 22: State Bank ➔ Mangalore Junction Station (MAJN)
  // -------------------------------------------------------------
  { route_id: 'r0000001-0000-0000-0000-000000000009', stop_id: 'b0000001-0000-0000-0000-000000000001', stop_sequence: 1, distance_from_start_km: 0.0, time_from_start_mins: 0, is_major_interchange: true },
  { route_id: 'r0000001-0000-0000-0000-000000000009', stop_id: 'b0000001-0000-0000-0000-000000000012', stop_sequence: 2, distance_from_start_km: 3.5, time_from_start_mins: 10, is_major_interchange: true },
  { route_id: 'r0000001-0000-0000-0000-000000000009', stop_id: 'b0000001-0000-0000-0000-000000000013', stop_sequence: 3, distance_from_start_km: 5.5, time_from_start_mins: 14, is_major_interchange: true },
  { route_id: 'r0000001-0000-0000-0000-000000000009', stop_id: 'b0000001-0000-0000-0000-000000000022', stop_sequence: 4, distance_from_start_km: 7.2, time_from_start_mins: 20, is_major_interchange: true },

  // -------------------------------------------------------------
  // Route 33: KSRTC Bejai ➔ Mangalore University (via Mallikatta & Pumpwell)
  // -------------------------------------------------------------
  { route_id: 'r0000001-0000-0000-0000-000000000010', stop_id: 'b0000001-0000-0000-0000-000000000005', stop_sequence: 1, distance_from_start_km: 0.0, time_from_start_mins: 0, is_major_interchange: true },
  { route_id: 'r0000001-0000-0000-0000-000000000010', stop_id: 'b0000001-0000-0000-0000-000000000020', stop_sequence: 2, distance_from_start_km: 2.5, time_from_start_mins: 7, is_major_interchange: true },
  { route_id: 'r0000001-0000-0000-0000-000000000010', stop_id: 'b0000001-0000-0000-0000-000000000012', stop_sequence: 3, distance_from_start_km: 4.2, time_from_start_mins: 12, is_major_interchange: true },
  { route_id: 'r0000001-0000-0000-0000-000000000010', stop_id: 'b0000001-0000-0000-0000-000000000013', stop_sequence: 4, distance_from_start_km: 5.8, time_from_start_mins: 16, is_major_interchange: true },
  { route_id: 'r0000001-0000-0000-0000-000000000010', stop_id: 'b0000001-0000-0000-0000-000000000014', stop_sequence: 5, distance_from_start_km: 9.8, time_from_start_mins: 24, is_major_interchange: true },
  { route_id: 'r0000001-0000-0000-0000-000000000010', stop_id: 'b0000001-0000-0000-0000-000000000015', stop_sequence: 6, distance_from_start_km: 14.0, time_from_start_mins: 32, is_major_interchange: true },
  { route_id: 'r0000001-0000-0000-0000-000000000010', stop_id: 'b0000001-0000-0000-0000-000000000016', stop_sequence: 7, distance_from_start_km: 18.0, time_from_start_mins: 40, is_major_interchange: true },

  // -------------------------------------------------------------
  // Route 16: Kottara Chowki ➔ Surathkal NITK Shuttle
  // -------------------------------------------------------------
  { route_id: 'r0000001-0000-0000-0000-000000000011', stop_id: 'b0000001-0000-0000-0000-000000000006', stop_sequence: 1, distance_from_start_km: 0.0, time_from_start_mins: 0, is_major_interchange: true },
  { route_id: 'r0000001-0000-0000-0000-000000000011', stop_id: 'b0000001-0000-0000-0000-000000000007', stop_sequence: 2, distance_from_start_km: 2.7, time_from_start_mins: 6, is_major_interchange: false },
  { route_id: 'r0000001-0000-0000-0000-000000000011', stop_id: 'b0000001-0000-0000-0000-000000000008', stop_sequence: 3, distance_from_start_km: 5.5, time_from_start_mins: 11, is_major_interchange: true },
  { route_id: 'r0000001-0000-0000-0000-000000000011', stop_id: 'b0000001-0000-0000-0000-000000000009', stop_sequence: 4, distance_from_start_km: 8.0, time_from_start_mins: 16, is_major_interchange: false },
  { route_id: 'r0000001-0000-0000-0000-000000000011', stop_id: 'b0000001-0000-0000-0000-000000000010', stop_sequence: 5, distance_from_start_km: 11.0, time_from_start_mins: 20, is_major_interchange: true },
  { route_id: 'r0000001-0000-0000-0000-000000000011', stop_id: 'b0000001-0000-0000-0000-000000000011', stop_sequence: 6, distance_from_start_km: 13.5, time_from_start_mins: 25, is_major_interchange: true },

  // -------------------------------------------------------------
  // Route 47: Deralakatte Medical Hub ➔ Mudipu IT SEZ
  // -------------------------------------------------------------
...
export const initialSchedules = [
  { id: 's01', route_id: 'r0000001-0000-0000-0000-000000000001', departure_time: '06:00:00', arrival_time: '22:30:00', frequency_mins: 8, bus_plate_number: 'KA-19-AB-1515' },
  { id: 's02', route_id: 'r0000001-0000-0000-0000-000000000002', departure_time: '06:15:00', arrival_time: '22:00:00', frequency_mins: 10, bus_plate_number: 'KA-19-AC-1111' },
  { id: 's03', route_id: 'r0000001-0000-0000-0000-000000000003', departure_time: '06:30:00', arrival_time: '21:30:00', frequency_mins: 15, bus_plate_number: 'KA-19-AD-4242' },
  { id: 's04', route_id: 'r0000001-0000-0000-0000-000000000004', departure_time: '06:00:00', arrival_time: '23:00:00', frequency_mins: 25, bus_plate_number: 'KA-19-AE-2727' },
  { id: 's05', route_id: 'r0000001-0000-0000-0000-000000000005', departure_time: '06:00:00', arrival_time: '22:00:00', frequency_mins: 8, bus_plate_number: 'KA-19-AF-2424' },
  { id: 's06', route_id: 'r0000001-0000-0000-0000-000000000006', departure_time: '07:00:00', arrival_time: '21:00:00', frequency_mins: 15, bus_plate_number: 'KA-19-AG-1919' },
  { id: 's07', route_id: 'r0000001-0000-0000-0000-000000000007', departure_time: '06:30:00', arrival_time: '21:30:00', frequency_mins: 12, bus_plate_number: 'KA-19-AH-0303' },
  { id: 's08', route_id: 'r0000001-0000-0000-0000-000000000008', departure_time: '06:45:00', arrival_time: '21:45:00', frequency_mins: 15, bus_plate_number: 'KA-19-AJ-4444' },
...
export const initialFares = [
  ...
  { id: 'f01', route_id: 'r0000001-0000-0000-0000-000000000001', from_stop_id: 'b0000001-0000-0000-0000-000000000001', to_stop_id: 'b0000001-0000-0000-0000-000000000006', regular_fare: 25.00, student_fare: 12.00 },
  { id: 'f02', route_id: 'r0000001-0000-0000-0000-000000000001', from_stop_id: 'b0000001-0000-0000-0000-000000000001', to_stop_id: 'b0000001-0000-0000-0000-000000000008', regular_fare: 35.00, student_fare: 18.00 },
  { id: 'f03', route_id: 'r0000001-0000-0000-0000-000000000001', from_stop_id: 'b0000001-0000-0000-0000-000000000001', to_stop_id: 'b0000001-0000-0000-0000-000000000011', regular_fare: 50.00, student_fare: 25.00 },
  { id: 'f04', route_id: 'r0000001-0000-0000-0000-000000000001', from_stop_id: 'b0000001-0000-0000-0000-000000000006', to_stop_id: 'b0000001-0000-0000-0000-000000000011', regular_fare: 35.00, student_fare: 18.00 },

  // Route 11: State Bank ➔ Mangalore University
  { id: 'f05', route_id: 'r0000001-0000-0000-0000-000000000002', from_stop_id: 'b0000001-0000-0000-0000-000000000001', to_stop_id: 'b0000001-0000-0000-0000-000000000012', regular_fare: 18.00, student_fare: 9.00 },
  { id: 'f06', route_id: 'r0000001-0000-0000-0000-000000000002', from_stop_id: 'b0000001-0000-0000-0000-000000000001', to_stop_id: 'b0000001-0000-0000-0000-000000000013', regular_fare: 22.00, student_fare: 11.00 },
  { id: 'f07', route_id: 'r0000001-0000-0000-0000-000000000002', from_stop_id: 'b0000001-0000-0000-0000-000000000001', to_stop_id: 'b0000001-0000-0000-0000-000000000015', regular_fare: 35.00, student_fare: 18.00 },
  { id: 'f08', route_id: 'r0000001-0000-0000-0000-000000000002', from_stop_id: 'b0000001-0000-0000-0000-000000000001', to_stop_id: 'b0000001-0000-0000-0000-000000000016', regular_fare: 45.00, student_fare: 20.00 },
  { id: 'f09', route_id: 'r0000001-0000-0000-0000-000000000002', from_stop_id: 'b0000001-0000-0000-0000-000000000013', to_stop_id: 'b0000001-0000-0000-0000-000000000016', regular_fare: 32.00, student_fare: 16.00 },

  // Route 42: State Bank ➔ Mudipu Infosys
  { id: 'f10', route_id: 'r0000001-0000-0000-0000-000000000003', from_stop_id: 'b0000001-0000-0000-0000-000000000001', to_stop_id: 'b0000001-0000-0000-0000-000000000018', regular_fare: 55.00, student_fare: 28.00 },
  { id: 'f11', route_id: 'r0000001-0000-0000-0000-000000000003', from_stop_id: 'b0000001-0000-0000-0000-000000000015', to_stop_id: 'b0000001-0000-0000-0000-000000000018', regular_fare: 25.00, student_fare: 12.00 },

  // Route 27: State Bank ➔ Airport
  { id: 'f12', route_id: 'r0000001-0000-0000-0000-000000000004', from_stop_id: 'b0000001-0000-0000-0000-000000000001', to_stop_id: 'b0000001-0000-0000-0000-000000000023', regular_fare: 60.00, student_fare: 30.00 },
  { id: 'f13', route_id: 'r0000001-0000-0000-0000-000000000004', from_stop_id: 'b0000001-0000-0000-0000-000000000005', to_stop_id: 'b0000001-0000-0000-0000-000000000023', regular_fare: 45.00, student_fare: 22.00 },

  // Route 24A: State Bank ➔ Kottara Chowki
  { id: 'f14', route_id: 'r0000001-0000-0000-0000-000000000005', from_stop_id: 'b0000001-0000-0000-0000-000000000001', to_stop_id: 'b0000001-0000-0000-0000-000000000006', regular_fare: 25.00, student_fare: 12.00 },
  { id: 'f15', route_id: 'r0000001-0000-0000-0000-000000000005', from_stop_id: 'b0000001-0000-0000-0000-000000000001', to_stop_id: 'b0000001-0000-0000-0000-000000000004', regular_fare: 15.00, student_fare: 8.00 },

  // Route 19: State Bank ➔ Panambur Beach
  { id: 'f16', route_id: 'r0000001-0000-0000-0000-000000000006', from_stop_id: 'b0000001-0000-0000-0000-000000000001', to_stop_id: 'b0000001-0000-0000-0000-000000000008', regular_fare: 30.00, student_fare: 15.00 },

  // Route 3A: State Bank ➔ Kadri
  { id: 'f17', route_id: 'r0000001-0000-0000-0000-000000000007', from_stop_id: 'b0000001-0000-0000-0000-000000000001', to_stop_id: 'b0000001-0000-0000-0000-000000000019', regular_fare: 18.00, student_fare: 9.00 },

  // Route 44: State Bank ➔ Ullal
  { id: 'f18', route_id: 'r0000001-0000-0000-0000-000000000008', from_stop_id: 'b0000001-0000-0000-0000-000000000001', to_stop_id: 'b0000001-0000-0000-0000-000000000024', regular_fare: 30.00, student_fare: 15.00 },

  // Route 22: State Bank ➔ Mangalore Junction
  { id: 'f19', route_id: 'r0000001-0000-0000-0000-000000000009', from_stop_id: 'b0000001-0000-0000-0000-000000000001', to_stop_id: 'b0000001-0000-0000-0000-000000000022', regular_fare: 22.00, student_fare: 11.00 },

  // Route 33: KSRTC Bejai ➔ Mangalore University
  { id: 'f20', route_id: 'r0000001-0000-0000-0000-000000000010', from_stop_id: 'b0000001-0000-0000-0000-000000000005', to_stop_id: 'b0000001-0000-0000-0000-000000000016', regular_fare: 45.00, student_fare: 20.00 },

  // Route 16: Kottara Chowki ➔ Surathkal NITK
